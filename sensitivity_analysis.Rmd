...
compareGroups::export2csv(table1_sens, file = paste0(output_path, 'sens_inexclude_0215.csv'))
```
...
z_lst = c(2.98, 1.8, 1.74, 1.74, 0.3, -0.16, 0.18, 0.13)
for(z in z_lst) {
...
```{r}
z_lst = c(2.51, 1.49, 1.73, 1.73, 0.98, 0.33, 0.74, 0.68)
for(z in z_lst) {
  print(convert.z.score(z))
}
```
...
z_lst = c(0.55, -0.36, -0.23, -0.26, -1.59, -0.60, -0.42, -0.33)
for(z in z_lst) {
  print(convert.z.score(z))
}
```
